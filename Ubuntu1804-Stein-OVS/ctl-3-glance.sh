...
glance_config_api () {
	...
	ops_add $glanceapifile keystone_authtoken auth_uri http://$CTL_EXT_IP:5000	  
...
glance_config_registry () {
	...
	ops_add $glanceregistryfile database connection mysql+pymysql://glance:$GLANCE_DBPASS@$CTL_EXT_IP/glance
	ops_add $glanceregistryfile keystone_authtoken auth_uri http://$CTL_EXT_IP:5000
	ops_add $glanceregistryfile keystone_authtoken auth_url http://$CTL_EXT_IP:5000		
	ops_add $glanceregistryfile keystone_authtoken memcached_servers $CTL_EXT_IP:11211		
